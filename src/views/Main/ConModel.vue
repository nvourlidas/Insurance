        ...
        <CTable striped bordered>
            ...
            <CTableBody>
                <CTableRow style="text-align: center;">
                    ...
                    <CTableDataCell>{{ con.bname }} <p v-if="con.pinakida"> Αριθμός Κυκλοφορίας: {{ con.pinakida }}</p></CTableDataCell>
                    ...
                    <CTableDataCell v-if="con.paymentmethod == 4">Ετήσια</CTableDataCell>
                    <CTableDataCell v-if="con.paymentmethod == 5">'Εως Λήξη Συμβολαίου</CTableDataCell>
